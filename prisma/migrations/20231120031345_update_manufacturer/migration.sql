/*
  ...
  - Added the required column `country` to the `Manufacturer` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Manufacturer" ADD COLUMN     "country" TEXT NOT NULL;
